...
if __name__ == "__main__":
    bucket_name = "macimus-cloudtrail-logs"
    log_key = "AWSLogs/423623825149/CloudTrail/ap-northeast-2/2025/01/10/423623825149_CloudTrail_ap-northeast-2_20250110T0045Z_PTsOCFJLZMQciHAN.json.gz"
