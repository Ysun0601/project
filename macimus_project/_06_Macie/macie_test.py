...
def create_all_identifiers():
    ...
    identifiers['bank_account'] = create_custom_data_identifier_with_severity(
        name="BankAccount-Identifier",
        regex=r"\b\d{11,14}\b",  # 계좌번호 형식: 000-00-000000
        description="계좌번호 형식 탐지",
        threshold=1,  # 최소 일치 횟수
        severity="HIGH",  # 민감도: HIGH
        tags={"Sensitivity": "HIGH"}  # 태그: HIGH 민감도
    )
    ...
    # Address Identifier
    identifiers['address'] = create_custom_data_identifier_with_severity(
    ...
    identifiers['phone_number'] = create_custom_data_identifier_with_severity(
