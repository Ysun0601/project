...
def add_eventbridge_trigger_to_lambda():
    lambda_function_name = "DetectUnauthorizedS3Access2"
    eventbridge_rule_name = "DetectUnauthorizedAccess2"
    ...
    try:
        ...
        try:
            ...
            print(f"Permission added to Lambda function '{lambda_function_name}' for EventBridge rule '{eventbridge_rule_name}'.")
